...
There is a very high concentration of beneficiary frequencies in Bidur-2, likely due to its relative accessibility and the presence of several holding centres within that ward. This is also evident in the map of beneficiary frequencies in the map below. 
...
Also from the map, we note a non-insignificant amount of humanitarian assistance that are outside of the affected areas. These are summarised in the table below. Some of these interventions were in more distant holding centres, like those in Kathmandu; however, some of the activities reported were within affected municipalities but still quite distant from the flooding. 
